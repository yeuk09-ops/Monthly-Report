...
# 2. HK Monthly Sales - ACT_SALE_AMT column
...
# 5. Summary
print("\n" + "=" * 120)
print("CREDIT VERIFICATION SUMMARY (Unit: 100 mil KRW)")
print("=" * 120)
...
print("\n" + "-" * 90)
print("Analysis:")
print(f"  - CHINA: AR {cn_ar_total:.0f} / Monthly Avg {cn_avg:.1f} = {cn_months:.1f} months")
print(f"  - HONG KONG: AR {hk_ar_total:.0f} / Monthly Avg {hk_avg:.1f} = {hk_months:.1f} months")
print("=" * 120)
